...
def train_transformer():
    ...
    classifier.set_bkd(bait_scaling=0.5, zeta=640.0, head_constant=1.0)
    ...
    classifier.initialize(dl_train=tr_dl, passing_mode='close_block', backdoorblock='encoder_layer_0',
                          encoderblocks=encoderblocks, synthesizeblocks='encoder_layer_11', num_active_bkd=32, v_scaling=1.0)
    ...
    num_epochs = 1
    device = 'cpu'
    save_path = './weights/transformer_v1.pth'
