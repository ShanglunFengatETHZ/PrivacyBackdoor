...
def initialize_model(info_model, resolution, classes, dataset, dl_target_distribution):
...
def build_model(info_dataset, info_model, info_train, logger, save_path):
    ...
    model = initialize_model(info_model, resolution=resolution, classes=classes,
